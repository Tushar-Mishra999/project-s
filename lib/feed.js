...
async function summariseViaUrlContext(url, model) {
  ...
  return generateText({
    model,
    user: `Summarise this article in 2-3 sentences. Focus on: what the development is, who is involved, and why it matters for the AI/technology industry. Be factual and concise. Do not start with 'This article'.\n\nURL: ${url}\n\nArticle text:\n${text}`,
    maxTokens: 300,
  });
}
