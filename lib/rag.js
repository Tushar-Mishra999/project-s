...
import { anthropic, voyage } from './clients.js';
...
export async function embedText(text, model = 'voyage-3', inputType) {
  ...
  // inputType helps Voyage tune the embedding for the use case.
  // 'document' for ingested chunks; 'query' for retrieval queries.
