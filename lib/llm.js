...
// Multi-turn chat via Vertex AI dedicated endpoint (Gemma 4) using chatCompletions format.
export async function generateChatGemma({ system, messages, maxTokens = 2048 }) {
  ...
  const resp = await fetch(
    `https://mg-endpoint-6e36e7de-7a34-4edd-b289-0d41d8035d63.us-central1-941913920085.prediction.vertexai.goog/v1/projects/${project}/locations/us-central1/endpoints/mg-endpoint-6e36e7de-7a34-4edd-b289-0d41d8035d63:predict`,
    {
      method: 'POST',
  ...
  return json.predictions[0].choices[0].message.content.trim();
}
