...
export async function generateChatGemma({ system, messages, maxTokens = 1024 }) {
  ...
  const resp = await fetch(
    `https://${location}-aiplatform.googleapis.com/v1beta1/projects/${project}/locations/${location}/endpoints/mg-endpoint-6e36e7de-7a34-4edd-b289-0d41d8035d63/chat/completions`,
    {
      method: 'POST',
