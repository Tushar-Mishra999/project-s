...
// Multi-turn chat via Vertex AI OpenAI-compatible endpoint (used for Gemma 4).
export async function generateChatGemma({ system, messages, maxTokens = 1024 }) {
  ...
  const resp = await fetch(
    `https://1524477819713748992.us-central1-142381987276.prediction.vertexai.goog/v1beta1/projects/${project}/locations/${location}/endpoints/mg-endpoint-6e36e7de-7a34-4edd-b289-0d41d8035d63/chat/completions`,
    {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
      body: JSON.stringify({ model: 'google/gemma-4-27b-it', messages: oaiMessages, max_tokens: maxTokens }),
